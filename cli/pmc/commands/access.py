...
ACCOUNT_NAMES_HELP = (
    f"{LIST_SEPARATOR.Name}-separated list of account names you want to operate on."
)
...
PACKAGE_NAMES_HELP = (
    f"{LIST_SEPARATOR.Name}-separated list of package names you want to operate on."
)
