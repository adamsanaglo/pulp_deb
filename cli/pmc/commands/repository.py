...
ADD_PACKAGES_HELP = f"{LIST_SEPARATOR.Name}-separated list of package ids to add."
REMOVE_PACKAGES_HELP = f"{LIST_SEPARATOR.Name}-separated list of package ids to remove."
RELEASE_HELP = (
...
def create(
    ...
    releases: Optional[str] = typer.Option(
        None, help=f"{LIST_SEPARATOR.Name}-separated list of release names"
    ),
    paths: Optional[str] = typer.Option(
        None, help=f"{LIST_SEPARATOR.Name}-separated list of distribution paths"
    ),
