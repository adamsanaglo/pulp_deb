...
DISTRIBUTIONS_HELP = f"{LIST_SEPARATOR.Name}-separated list of releases/dists."
COMPONENTS_HELP = f"{LIST_SEPARATOR.Name}-separated list of comps."
ARCHITECTURES_HELP = f"{LIST_SEPARATOR.Name}-separated list of architectures."
